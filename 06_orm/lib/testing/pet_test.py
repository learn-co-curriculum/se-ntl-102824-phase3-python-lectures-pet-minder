...
class TestPet:
    ...
    def test_has_all_attributes(self):
        ...
        assert (
            pet.name == "spot"
            and pet.species == "dog"
            and pet.breed == "chihuahua"
            and pet.temperament == "feisty"
            and pet.owner_id == 1
        )
    ...
    def test_gets_all(self):
        ...
        assert (
            ...
            pets[0].temperament,
            pets[0].owner_id,
        ) == (1, "spot", "dog", "chihuahua", "feisty", 1) and (
            pets[1].id,
            pets[1].name,
            pets[1].species,
            pets[1].breed,
    ...
    def test_finds_by_name_and_breed(self):
        ...
        assert (spot.id, spot.name, spot.breed) == (1, "spot", "chihuahua")
    ...
    def test_updates_record(self):
        ...
        assert Pet.find_by_id(1).name == "carlos" and Pet.find_by_name("spot") == None
